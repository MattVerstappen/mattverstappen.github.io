...
const TRANSLATIONS = {
    ...
    en: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'Cinematic Wormhole Vortex',
        cc_demo6_sub:     'A cinematic wormhole rendered entirely with the Canvas 2D API. No WebGL, no libraries - pure mathematics driving a spiral tunnel through space.',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'Cinematic Solar System',
        cc_demo7_sub:     'A full 3D solar system built with Three.js. Real planetary textures, day/night cycles, atmospheric effects, Saturn\'s rings, and an interactive camera. Opens as a standalone experience.',
        cc_solar_launch:  'Launch Solar System',
        cc_solar_note:    'Opens in a new tab - best experienced fullscreen',
    ...
    af: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'Sinematografiese Wurmgatwerweling',
        cc_demo6_sub:     '\'n Sinematografiese wurmgat wat uitsluitlik met die Canvas 2D-API weergegee word. Geen WebGL, geen biblioteke nie - suiwer wiskunde wat \'n spiraaltunnel deur die ruimte aandryf.',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'Sinematografiese Sonnestelsel',
        cc_demo7_sub:     '\'n Volledige 3D-sonnestelsel gebou met Three.js. Regte planetere teksture, dag/nag-siklusse, atmosferiese effekte, Saturnus se ringe en \'n interaktiewe kamera. Maak oop as \'n selfstandige ervaring.',
        cc_solar_launch:  'Lanseer Sonnestelsel',
        cc_solar_note:    'Maak oop in \'n nuwe oortjie - beste beleef in volskerm',
    ...
    es: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'Vortice de Agujero de Gusano Cinematico',
        cc_demo6_sub:     'Un agujero de gusano cinematico renderizado completamente con la API Canvas 2D. Sin WebGL, sin librerias - matematica pura impulsando un tunel espiral a traves del espacio.',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'Sistema Solar Cinematico',
        cc_demo7_sub:     'Un sistema solar 3D completo construido con Three.js. Texturas planetarias reales, ciclos dia/noche, efectos atmosfericos, los anillos de Saturno y una camara interactiva. Se abre como una experiencia independiente.',
        cc_solar_launch:  'Lanzar Sistema Solar',
        cc_solar_note:    'Se abre en una pestana nueva - mejor a pantalla completa',
    ...
    fr: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'Vortex de Trou de Ver Cinematique',
        cc_demo6_sub:     'Un trou de ver cinematique rendu entierement avec l\'API Canvas 2D. Pas de WebGL, pas de bibliotheques - des mathematiques pures propulsant un tunnel en spirale a travers l\'espace.',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'Systeme Solaire Cinematique',
        cc_demo7_sub:     'Un systeme solaire 3D complet construit avec Three.js. Textures planetaires reelles, cycles jour/nuit, effets atmospheriques, les anneaux de Saturne et une camera interactive. S\'ouvre comme une experience autonome.',
        cc_solar_launch:  'Lancer le Systeme Solaire',
        cc_solar_note:    'S\'ouvre dans un nouvel onglet - meilleure experience en plein ecran',
    ...
    zh: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: '电影级虫洞漩涡',
        cc_demo6_sub:     '完全使用 Canvas 2D API 渲染的电影级虫洞。无 WebGL，无库依赖 - 纯数学驱动螺旋隧道穿越宇宙。',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: '电影级太阳系',
        cc_demo7_sub:     '使用 Three.js 构建的完整 3D 太阳系。真实行星纹理、昼夜循环、大气效果、土星环和交互式相机。作为独立体验打开。',
        cc_solar_launch:  '启动太阳系',
        cc_solar_note:    '在新标签页中打开 - 全屏效果最佳',
        nav_research:     '研究',
        nav_achievements: '成就',
        nav_contact:      '联系',
    ...
    hi: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'सिनेमाई वर्महोल भंवर',
        cc_demo6_sub:     'Canvas 2D API से पूरी तरह रेंडर किया गया सिनेमाई वर्महोल। कोई WebGL नहीं, कोई लाइब्रेरी नहीं - शुद्ध गणित अंतरिक्ष के माध्यम से एक सर्पिल सुरंग को संचालित करती है।',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'सिनेमाई सौर मंडल',
        cc_demo7_sub:     'Three.js से बना पूर्ण 3D सौर मंडल। वास्तविक ग्रहीय बनावट, दिन/रात चक्र, वायुमंडलीय प्रभाव, शनि के छल्ले और इंटरएक्टिव कैमरा। एक स्वतंत्र अनुभव के रूप में खुलता है।',
        cc_solar_launch:  'सौर मंडल लॉन्च करें',
        cc_solar_note:    'नए टैब में खुलता है - फुलस्क्रीन में सबसे अच्छा अनुभव',
        nav_research:     'शोध',
    ...
    ar: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'دوامة ثقب الدودة السينمائية',
        cc_demo6_sub:     'ثقب دودة سينمائي مقدم بالكامل باستخدام Canvas 2D API. بدون WebGL وبدون مكتبات - رياضيات بحتة تقود نفقا حلزونيا عبر الفضاء.',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'المجموعة الشمسية السينمائية',
        cc_demo7_sub:     'نظام شمسي ثلاثي الابعاد كامل مبني بـ Three.js. نسيج كوكبي حقيقي ودورات النهار والليل وتاثيرات جوية وحلقات زحل وكاميرا تفاعلية. يفتح كتجربة مستقلة.',
        cc_solar_launch:  'تشغيل المجموعة الشمسية',
        cc_solar_note:    'يفتح في تبويب جديد - افضل تجربة في وضع ملء الشاشة',
        nav_research:     'البحث',
    ...
    ja: {
        ...
        label_demo_6:     'Demo 06',
        cc_demo6_heading: 'シネマティック・ワームホール・ボルテックス',
        cc_demo6_sub:     'Canvas 2D APIのみで描画したシネマティックなワームホール。WebGLもライブラリも不要 - 純粋な数学が宇宙を貫くらせんトンネルを生み出します。',
        label_demo_7:     'Demo 07',
        cc_demo7_heading: 'シネマティック太陽系',
        cc_demo7_sub:     'Three.jsで構築した本格的な3D太陽系。本物の惑星テクスチャ、昼夜サイクル、大気効果、土星の輪、インタラクティブカメラを搭載。スタンドアロン体験として開きます。',
        cc_solar_launch:  '太陽系を起動',
        cc_solar_note:    '新しいタブで開きます - フルスクリーンで最高の体験',
        nav_research:     '研究',
        nav_achievements: '実績',
        nav_contact:      'お問い合わせ',
