...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showErrorMessage() {
        ...
        errorDiv.innerHTML = `
      <h3 style="margin-bottom: 1rem; color: var(--primary);">No Projects Found</h3>
      <p style="margin-bottom: 1rem;">The projects data couldn't be loaded.</p>
      <p style="font-size: 0.9rem; opacity: 0.8;">
        To fix this, run the build script: <code style="background: var(--muted); padding: 0.2rem 0.5rem; border-radius: 4px;">npm run build:projects</code>
      </p>
    `;
    ...
    async function loadProjects() {
        try {
            ...
            projectsGrid.innerHTML = '<p style="text-align: center; color: var(--border); opacity: 0.7;">Loading projects...</p>';
