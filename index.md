...
C#, C++, Java, JavaScript, Kotlin

### Game Engines & 3D

Unity, Unreal Engine, Blender, 3ds Max

### Tools & IDEs

Visual Studio, JetBrains Rider, Android Studio, Git, GitHub, Photoshop

### Other Skills

Design Leadership, VR Research, Team Coaching, Academic Tutoring
...
- **Engine:** Unity (C#, Blender, Photoshop)
- **Event:** National Vega Game Jam & Creative Conscience
- **Awards:** National Vega Game Jam Award Winner; Shortlisted for Creative Conscience
- **Date:** October 30, 2023
- **Description:** A 2D fixed shooter using retro-styled gameplay where you journey through the body to kill cancer. Players fight through 3 increasingly corrupted levels, each featuring 3 waves and a boss fight, raising awareness of testicular cancer in partnership with Love Your Nuts.
- [Play on itch.io](https://itch.io/embed/2710574) | [View project](https://matthewderekrall.com/project.html?slug=cancer-crusher)
...
- **Awards:** 3rd Place
- **Date:** July 13, 2024
- **Description:** A top-down 2D shooter where players battle relentless waves of zombies, unlocking powerful new weapons as they face the undead horde. Developed for a Game Jam, this roguelike game challenges players to control Timmy, strategically fighting off enemies and surviving increasingly difficult waves.
- [Play on itch.io](https://itch.io/embed/2829359) | [View project](https://matthewderekrall.com/project.html?slug=timmys-revenge)
...
- **Engine:** Unity (C#, Blender, Photoshop)
- **Event:** Ludum Dare 56
- **Awards:** Top 500 (Rank 475)
- **Date:** Oct 08, 2024
- **Description:** Cafe styled gameplay experience made for Ludum Dare 56.
- [Play on itch.io](https://itch.io/embed/3027046) | [View project](https://matthewderekrall.com/project.html?slug=tiny-cafe)

#### Cardmageddon
- **Status:** Completed
- **Type:** Game · Action / Card Game
- **Degree:** BCIS in Game Design and Development
- **Engine:** Unity (C#, Blender, Photoshop)
- **Event:** Ludum Dare 55
...
- **Engine:** Unity (C#, Blender, Photoshop)
- **Date:** Jun 26, 2023
- **Description:** Embark on an epic journey through challenging dungeons, battling enemies and uncovering hidden treasures. This game blends engaging combat with rich storytelling, creating an immersive experience in a visually captivating world.
- [Play on itch.io](https://itch.io/embed/2135839) | [View project](https://matthewderekrall.com/project.html?slug=from-the-shadows)
...
- **Degree:** BCIS in Game Design and Development
- **Stack:** Android Studio, Kotlin, HTML, Firebase
- **Date:** November 2024
- **Description:** An Android time tracking app with both local and cloud database saves to manage user information. Features time entry creation, timesheet views, a Pomodoro timer, audio explanations of each app function, and more.
- [View project](https://matthewderekrall.com/project.html?slug=leap-time)
...
- **Stack:** Word, Google Docs, Obsidian, Photoshop
- **Description:** Phenomenological study interviewing five third-year computer science students on VR-based learning. Thematic analysis across six themes: hardware access, immersion, learning curves, collaboration, curriculum gaps, and programming mindset. Published with DOI.
- [DOI](https://doi.org/10.13140/RG.2.2.32898.95688) | [View project](https://matthewderekrall.com/project.html?slug=exploring-vr-in-game-development-education)
...
- **Type:** Research
- **Degree:** BA Honours in Design Leadership
- **Description:** Case study of Cory Barlog, Creative Director of Sony's Santa Monica Studio, analysing his direction of God of War (2018) as an example of visionary, transformational, and reflexive leadership in AAA game development.
- [View project](https://matthewderekrall.com/project.html?slug=design-leadership-cory-barlog)
...
- **Type:** Design
- **Degree:** BA Honours in Design Leadership
- **Description:** Proposed design of a mobile financial literacy game for South African youth, using choice-driven narrative mechanics and culturally grounded characters. Includes UI wireframes, character designs, and a moodboard.
- [View project](https://matthewderekrall.com/project.html?slug=financial-literacy-game)

#### Pixel to Platform: Redesigning Atlas Games' Website as a Strategic Design Tool
- **Status:** Completed
- **Type:** Design
- **Degree:** BA Honours in Design Leadership
- **Description:** Design strategy and management plan for redesigning the website of Atlas Games, a South African indie game studio. Grounded in User-Centred Design and Minimalist Aesthetics.
- [View project](https://matthewderekrall.com/project.html?slug=pixel-to-platform-atlas-games)

#### Business Plan: Atlas Games (Pty) Ltd
- **Status:** Completed
- **Type:** Design
- **Degree:** BA Honours in Design Leadership
- **Description:** Commercial strategy for Atlas Games (Pty) Ltd, a South African impact-first indie game studio. Hybrid B2B revenue model with six income streams, Year 1 projected revenue of R1,200,000.
- [View project](https://matthewderekrall.com/project.html?slug=atlas-games-business-plan)

#### System Saviour: A Modular Diagnostic Device for Accessible Tech Repair
- **Status:** Completed
- **Type:** Design
- **Degree:** BA Honours in Design Leadership
- **Description:** Proposed rugged, modular, offline-compatible diagnostic device addressing the gap in affordable tech repair tools across South Africa. Full hardware and software diagnostic report in under 30 seconds.
- [View project](https://matthewderekrall.com/project.html?slug=system-saviour)
...
**MDR Unity Toolkit** - A free, open-source collection of modular C# scripts for Unity 2022.3+, now live at [mdr-unity-toolkit](https://github.com/MattVerstappen/mdr-unity-toolkit). The toolkit page at [/toolkit.html](https://matthewderekrall.com/toolkit.html) lists all available scripts with links.
...
© 2026 Matthew Derek Rall. All rights reserved.

Durban, South Africa → United States

---

<!-- Note: The Projects section (project cards, filter chips, and degree filters) is rendered dynamically via JavaScript fetching from projects/manifest.json and individual project.json files. The full project content is preserved above from the source data. -->
