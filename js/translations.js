...
const TRANSLATIONS = {
    ...
    en: {
        ...
        label_creative_coding: 'Creative Coding',
        cc_heading: 'Browser Experiments',
        cc_sub: 'Interactive demos and creative coding built directly in the browser. Click anywhere on the demo to trigger a lightning strike.',
        label_demo_1: 'Demo 01',
        cc_demo1_heading: 'Binary Rain & Lightning',
        cc_demo1_sub: 'A real-time canvas animation built with vanilla JavaScript. Binary digits fall like rain while lightning bolts strike on click.',
        cc_more_heading: 'More experiments coming',
        cc_more_sub: 'This lab grows as I build. Check back for shader experiments, procedural generation, physics simulations, and more.',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'Purple Lightning & Rain',
        cc_demo2_sub:    'Procedural purple rain with branching lightning bolts. Click the frame to trigger a strike.',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'Atmospheric Temple FX',
        cc_demo3_sub:    'Pure CSS - no JavaScript required. Glowing sun orb, layered fortress silhouette, floating ember particles, and a CRT scanline overlay.',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'Black Hole',
        cc_demo4_sub:    'Pure CSS - spinning accretion disk, pulsing event horizon, and particle streams swirling outward into the void.',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'Meteor Shower',
        cc_demo5_sub:    'Dynamically generated meteors with realistic trail physics. Random angles, speeds, and positions - each meteor calculated individually.',
    ...
    af: {
        ...
        label_creative_coding: 'Kreatiewe Kodering',
        cc_heading: 'Blaaier-Eksperimente',
        cc_sub: 'Interaktiewe demos gebou direk in die blaaier. Klik enige plek op die demo om \'n weerligstaking te aktiveer.',
        label_demo_1: 'Demo 01',
        cc_demo1_heading: 'Binere Reen & Weerlig',
        cc_demo1_sub: '\'n Intydse doekanimering gebou met vanilla JavaScript. Binere syfers val soos reen terwyl weerligboute tref wanneer jy klik.',
        cc_more_heading: 'Meer eksperimente op pad',
        cc_more_sub: 'Hierdie laboratorium groei soos ek bou. Kom kyk weer vir skaduwee-eksperimente, prosedurele generering, fisika-simulasies en meer.',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'Pers Weerlig & Reen',
        cc_demo2_sub:    'Prosedurele pers reen met vertakkende weerligboute. Klik op die raam om \'n staking te aktiveer.',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'Atmosferiese Tempel-FX',
        cc_demo3_sub:    'Suiwer CSS - geen JavaScript benodig nie. Gloeiende sonbol, gelaagde vesting-silhoeette, swewende kolskooldeeltjies en \'n CRT-skandeerlynbedekking.',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'Swart Gat',
        cc_demo4_sub:    'Suiwer CSS - roterende akkresieskyf, pulserende gebeurtenishorison en deeltjiestrome wat uitwaarts wentel die nietigheid in.',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'Meteoorstorm',
        cc_demo5_sub:    'Dinamies gegenereerde meteore met realistiese sleepfisika. Ewekansige hoeke, spoed en posisies - elke meteoor word afsonderlik bereken.',
    ...
    es: {
        ...
        label_creative_coding: 'Codigo Creativo',
        cc_heading: 'Experimentos en el Navegador',
        cc_sub: 'Demos interactivos construidos directamente en el navegador. Haz clic en cualquier lugar del demo para activar un rayo.',
        label_demo_1: 'Demo 01',
        cc_demo1_heading: 'Lluvia Binaria y Relampagos',
        cc_demo1_sub: 'Una animacion de canvas en tiempo real construida con JavaScript puro. Digitos binarios caen como lluvia mientras los rayos golpean al hacer clic.',
        cc_more_heading: 'Mas experimentos proximamente',
        cc_more_sub: 'Este laboratorio crece mientras construyo. Vuelve para experimentos de shaders, generacion procedural, simulaciones de fisica y mas.',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'Relampago Purpura y Lluvia',
        cc_demo2_sub:    'Lluvia purpura procedural con rayos ramificados. Haz clic en el marco para activar un rayo.',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'FX Atmosferico del Templo',
        cc_demo3_sub:    'CSS puro - no se requiere JavaScript. Orbe solar brillante, silueta de fortaleza en capas, particulas de brasa flotantes y superposicion de lineas de escaneo CRT.',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'Agujero Negro',
        cc_demo4_sub:    'CSS puro - disco de acrecion giratorio, horizonte de eventos pulsante y corrientes de particulas que se arremolinan hacia el vacio.',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'Lluvia de Meteoros',
        cc_demo5_sub:    'Meteoros generados dinamicamente con fisica de estela realista. Angulos, velocidades y posiciones aleatorias - cada meteoro calculado individualmente.',
    ...
    fr: {
        ...
        label_creative_coding: 'Programmation Creative',
        cc_heading: 'Experiences dans le Navigateur',
        cc_sub: 'Demos interactives construites directement dans le navigateur. Cliquez n\'importe ou sur la demo pour declencher un eclair.',
        label_demo_1: 'Demo 01',
        cc_demo1_heading: 'Pluie Binaire et Eclairs',
        cc_demo1_sub: 'Une animation canvas en temps reel construite en JavaScript pur. Des chiffres binaires tombent comme de la pluie pendant que des eclairs frappent au clic.',
        cc_more_heading: 'Plus d\'experiences a venir',
        cc_more_sub: 'Ce laboratoire grandit au fil de mes constructions. Revenez pour des experiences de shaders, de la generation procedurale, des simulations physiques et bien plus.',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'Eclairs Violets et Pluie',
        cc_demo2_sub:    'Pluie violette procedurale avec des eclairs ramifies. Cliquez sur le cadre pour declencher un eclair.',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'FX Atmospherique du Temple',
        cc_demo3_sub:    'CSS pur - aucun JavaScript requis. Orbe solaire lumineux, silhouette de forteresse en couches, particules de braise flottantes et superposition de lignes de balayage CRT.',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'Trou Noir',
        cc_demo4_sub:    'CSS pur - disque d\'accretion tournant, horizon des evenements pulsant et flux de particules tourbillonnant vers le vide.',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'Pluie de Meteores',
        cc_demo5_sub:    'Meteores generes dynamiquement avec une physique de trainee realiste. Angles, vitesses et positions aleatoires - chaque meteore calcule individuellement.',
    ...
    zh: {
        ...
        label_creative_coding: '创意编程',
        cc_heading: '浏览器实验',
        cc_sub: '直接在浏览器中构建的互动演示。点击演示画面任意位置触发闪电。',
        label_demo_1: '演示 01',
        cc_demo1_heading: '二进制雨与闪电',
        cc_demo1_sub: '使用原生 JavaScript 构建的实时画布动画。二进制数字如雨点般下落，点击时闪电劈下。',
        cc_more_heading: '更多实验即将推出',
        cc_more_sub: '这个实验室随我的构建而增长。欢迎回来查看着色器实验、过程生成、物理模拟等更多内容。',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: '紫色闪电与雨',
        cc_demo2_sub:    '程序生成的紫色雨与分支闪电。点击画面触发雷击。',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: '神殿大气特效',
        cc_demo3_sub:    '纯 CSS - 无需 JavaScript。发光太阳球、层叠要塞剪影、漂浮余烬粒子和 CRT 扫描线叠加。',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: '黑洞',
        cc_demo4_sub:    '纯 CSS - 旋转吸积盘、脉动事件视界，以及向虚空旋转的粒子流。',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: '流星雨',
        cc_demo5_sub:    '动态生成的流星，具有真实的拖尾物理效果。随机角度、速度和位置 - 每颗流星单独计算。',
        nav_research:     '研究',
        nav_achievements: '成就',
        nav_contact:      '联系',
    ...
    hi: {
        ...
        label_creative_coding: 'क्रिएटिव कोडिंग',
        cc_heading: 'ब्राउजर प्रयोग',
        cc_sub: 'ब्राउजर में सीधे बनाए गए इंटरएक्टिव डेमो। लाइटनिंग स्ट्राइक के लिए डेमो पर कहीं भी क्लिक करें।',
        label_demo_1: 'डेमो 01',
        cc_demo1_heading: 'बाइनरी वर्षा और बिजली',
        cc_demo1_sub: 'वेनिला JavaScript से बना रियल-टाइम कैनवस एनिमेशन। क्लिक करने पर बिजली चमकती है जबकि बाइनरी अंक बारिश की तरह गिरते हैं।',
        cc_more_heading: 'और प्रयोग आ रहे हैं',
        cc_more_sub: 'यह लैब जैसे-जैसे मैं बनाता हूँ बढ़ता रहता है। शेडर प्रयोग, प्रोसीजरल जनरेशन, फिजिक्स सिमुलेशन के लिए वापस आएं।',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'बैंगनी बिजली और बारिश',
        cc_demo2_sub:    'शाखाओं वाली बिजली के साथ प्रक्रियात्मक बैंगनी बारिश। स्ट्राइक सक्रिय करने के लिए फ्रेम पर क्लिक करें।',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'वायुमंडलीय मंदिर FX',
        cc_demo3_sub:    'शुद्ध CSS - JavaScript की आवश्यकता नहीं। चमकता सूर्य गोला, स्तरित किला सिल्हूट, तैरते अंगारे के कण और CRT स्कैनलाइन ओवरले।',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'ब्लैक होल',
        cc_demo4_sub:    'शुद्ध CSS - घूमती अभिवृद्धि डिस्क, स्पंदित घटना क्षितिज और शून्य में घूमती कण धाराएं।',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'उल्का वर्षा',
        cc_demo5_sub:    'यथार्थवादी ट्रेल भौतिकी के साथ गतिशील रूप से उत्पन्न उल्काएं। यादृच्छिक कोण, गति और स्थिति - प्रत्येक उल्का अलग से गणना की गई।',
        nav_research:     'शोध',
    ...
    ar: {
        ...
        label_creative_coding: 'البرمجة الإبداعية',
        cc_heading: 'تجارب المتصفح',
        cc_sub: 'عروض تفاعلية مبنية مباشرة في المتصفح. انقر في أي مكان على العرض التوضيحي لتشغيل صاعقة.',
        label_demo_1: 'عرض 01',
        cc_demo1_heading: 'المطر الثنائي والبرق',
        cc_demo1_sub: 'رسوم متحركة على الكانفاس في الوقت الفعلي مبنية بـ JavaScript خالص. أرقام ثنائية تسقط كالمطر بينما تضرب الصواعق عند النقر.',
        cc_more_heading: 'المزيد من التجارب قادمة',
        cc_more_sub: 'يتنامى هذا المختبر مع ما أبنيه. عد لاحقًا لتجارب تظليل، وتوليد إجرائي، ومحاكاة فيزيائية والمزيد.',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'البرق الارجواني والمطر',
        cc_demo2_sub:    'مطر ارجواني اجرائي مع صواعق متفرعة. انقر على الاطار لتشغيل صاعقة.',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: 'مؤثرات المعبد الجوية',
        cc_demo3_sub:    'CSS خالص - لا يلزم JavaScript. كرة شمسية مضيئة وصورة ظلية لقلعة متعددة الطبقات وجزيئات جمر عائمة وطبقة خطوط مسح CRT.',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'الثقب الاسود',
        cc_demo4_sub:    'CSS خالص - قرص تراكم دوار وافق احداث نابض وتيارات جزيئات تتحرك نحو الفراغ.',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: 'زخة النيازك',
        cc_demo5_sub:    'نيازك مولدة ديناميكيا بفيزياء مسار واقعية. زوايا وسرعات ومواضع عشوائية - يتم حساب كل نيزك بشكل فردي.',
        nav_research:     'البحث',
    ...
    ja: {
        ...
        label_creative_coding: 'クリエイティブコーディング',
        cc_heading: 'ブラウザ実験',
        cc_sub: 'ブラウザで直接作成したインタラクティブなデモ。デモの任意の場所をクリックして雷を発生させてください。',
        label_demo_1: 'デモ 01',
        cc_demo1_heading: 'バイナリの雨と稲妻',
        cc_demo1_sub: '純粋なJavaScriptで構築したリアルタイムキャンバスアニメーション。クリックで雷が落ちる中、バイナリの数字が雨のように降り注ぎます。',
        cc_more_heading: 'さらなる実験を準備中',
        cc_more_sub: 'このラボは開発を続けるにつれて成長します。シェーダー実験、プロシージャル生成、物理シミュレーションなどをお楽しみに。',
        label_demo_2:    'Demo 02',
        cc_demo2_heading: 'パープルライトニング&レイン',
        cc_demo2_sub:    '枝分かれする雷を伴うプロシージャルな紫の雨。フレームをクリックして雷を発生させてください。',
        label_demo_3:    'Demo 03',
        cc_demo3_heading: '神殿アトモスフィアFX',
        cc_demo3_sub:    '純粋なCSS - JavaScriptは不要です。光り輝く太陽球、多層要塞シルエット、浮遊する燠火パーティクル、CRTスキャンラインオーバーレイ。',
        label_demo_4:    'Demo 04',
        cc_demo4_heading: 'ブラックホール',
        cc_demo4_sub:    '純粋なCSS - 回転する降着円盤、脈動する事象の地平面、虚空に向かって渦を巻く粒子流。',
        label_demo_5:    'Demo 05',
        cc_demo5_heading: '流星群',
        cc_demo5_sub:    'リアルなトレイル物理学を持つ動的に生成された流星。ランダムな角度、速度、位置 - 各流星は個別に計算されます。',
        nav_research:     '研究',
        nav_achievements: '実績',
        nav_contact:      'お問い合わせ',
